...
const cloudFileUpload = ({ validation = [], storageApproach = StorageEnum.disk, maxSizeMB = 2 }) => {
    ...
    function fileFilter(req, file, callback) {
        if (!validation.includes(file.mimetype)) {
            return callback(new error_response_1.BadRequestException("Validation Error", { validationErrors: [{ key: "file", issues: [{ path: "file", message: "invalid file format" }], },], }));
        }
